...
@RestController
@RequestMapping("/api/documentmanagmentms-kafka")
public class DocumentmanagmentmsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DocumentmanagmentmsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DocumentmanagmentmsKafkaResource(KafkaProperties kafkaProperties) {
